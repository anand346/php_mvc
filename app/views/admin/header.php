...
#postinput{border:1px solid #ddd;margin-bottom:5px;padding:5px;width:490px;font-size:16px;cursor:pointer;}
...
.adminright{width:577px;float:right;background:#fafafa none repeat scroll 0 0;padding:5px 10px;}
