...
.postcontent{width:560px;border-right:1px solid #ddd;float:left;margin-right:18px;padding-right:20px;overflow:hidden}
...
.title h2{margin:0;}
.title p{margin:0;padding:5px 0px;}
.desc{}
.desc p{line-height:24px;text-align:justify}
.searchoption{border-bottom :2px dashed #3399FF;padding-bottom:10px;margin-bottom: 15px;overflow:hidden}
...
<body>
  <header class="headeroption">
    <h2>Advanced PHP [MVC Framework]</h2>
